...
`configs/tracelab_k3_p24_d32_cpu_sweep_benchmark.json`: PREFILL
TP1/PP24/DP1 with pipeline-exclusive execution and DECODE
TP4/DCP4/PP1/DP8/EP32. The runner derives P/D GPU
...
the GPU KV occupancy stream. In the P24/D32 workload, runtime validation
...
# The P24/D32 sweep template is selected by default.
python .\cpp\experiments\kimi_k3_cpu_dram\run_dense_cpu_capacity_rate_sweep.py `
