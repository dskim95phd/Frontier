...
class BatchStage {
  public:
    BatchStage(BatchId batch_id, ReplicaId replica_id, DataParallelId dp_id,
               StageId stage_id, SimTime arrived_at,
    ...
    void accumulate_execution_time(const ExecutionTime &execution_time);
