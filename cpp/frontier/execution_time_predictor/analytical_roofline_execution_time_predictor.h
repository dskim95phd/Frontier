...
class BatchExecutionModel {
  public:
    ...
    [[nodiscard]] virtual BatchExecutionPrediction
...
class FixedBatchExecutionModel final : public BatchExecutionModel {
  public:
    explicit FixedBatchExecutionModel(config::FixedExecutionModelConfig config);
    FixedBatchExecutionModel(config::FixedExecutionModelConfig config,
                             config::ParallelismConfig parallelism,
                             config::ModelConfig model,
                             config::MoeRoutingConfig routing = {});

    [[nodiscard]] BatchExecutionPrediction
    predict(const entities::Batch &batch,
            const std::vector<entities::Request> &requests,
