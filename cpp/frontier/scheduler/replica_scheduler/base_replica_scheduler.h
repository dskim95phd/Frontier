...
class BaseReplicaScheduler {
  public:
    ...
    [[nodiscard]] virtual bool on_batch_completed(entities::Batch &batch,
                                                  SimTime time) = 0;
    ...
    [[nodiscard]] virtual bool has_in_flight_batch() const noexcept = 0;
    [[nodiscard]] virtual std::uint64_t
    in_flight_batch_count() const noexcept = 0;
    [[nodiscard]] virtual std::uint64_t
    pipeline_parallel_size() const noexcept = 0;
