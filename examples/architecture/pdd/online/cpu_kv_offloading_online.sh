#!/bin/bash
# Online sequential PDD counterpart of the prefill-side CPU KV example.
...
export RUN_ID="${RUN_ID:-cpu_kv_offloading_online}"
KV_CACHE_DTYPE="${KV_CACHE_DTYPE:-auto}"

exec bash "$SCRIPT_DIR/moe_prefix_caching_online.sh" -- \
